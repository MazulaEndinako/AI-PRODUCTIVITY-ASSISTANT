  ...
  head: () => ({
    meta: [
      ...
      { title: "Northlight | AI Workplace Productivity Assistant" },
      {
        name: "description",
        content:
          "AI email drafts, meeting summaries, task planning, research briefs and assistant chat in one dashboard.",
      },
      { property: "og:title", content: "Northlight | AI Workplace Productivity Assistant" },
      {
        property: "og:description",
        content: "One AI workspace for writing, planning and research.",
      },
